...
handler_warning= logging.handlers.RotatingFileHandler("./log/warning.log", mode="a", maxBytes= 1000000, backupCount= 1 , encoding="utf-8")
...
handler_info = logging.handlers.RotatingFileHandler("./log/info.log", mode="a", maxBytes= 1000000, backupCount= 1,encoding="utf-8")
